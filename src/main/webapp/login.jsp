            ...
            <div class="col-md-6 login-form-1">
                ...
                <form method="POST" action="login">
                    <div class="form-group">
                        <input name="loginUsername" type="text" class="form-control" placeholder="Username" value="${param.loginUsername}" />
                    </div>
                    <div class="form-group">
                        <input name="loginPasswrd" type="password" class="form-control" placeholder="Password" value="${param.loginPasswrd}" />
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btnSubmit" value="Login" />
                    </div>
                </form>
                <c:if test = "${loginErrorMsg != null || loginErrorMsg!=''}">
                    <p><c:out value = "${loginErrorMsg}"/><p>
                </c:if>
            </div>
        </div>
        ...
        <div class="container login-container .flex-center">
            <div class="col-md-6 login-form-1">
                ...
                <form method="post" action="register">
                    ...
                    <div class="form-group">
                        <input id="confirmPasswrd" name="registerConfirmPasswrd" type="password" class="form-control" placeholder="Confrim password" value="${param.registerConfirmPasswrd}" />
                    </div>
                    <div class="form-group">
